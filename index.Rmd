...
We adopt an MCMC scheme to estimate the model parameters. We sample each of the parameters other than \boldsymbol $\alpha$ based on its posterior distribution and estimate \boldsymbol $\alpha$ using an EM-like approach, and iterate over these steps until convergence:
